...
registerPlugin( 'tt4-book-reviews', {
	render: () => {
		...
		//console.log(meta?.themeslug_book_rating);
				...
				<VStack>
					<RangeControl
						...
						onChange={ ( value ) => setMeta( {
							...meta,
							themeslug_book_rating: parseInt( value ) > 0 ? parseInt( value ) : null
						} ) }
					/>
					<InputControl
					...
					<NumberControl
						...
						onChange={ ( value ) => setMeta( {
							...meta,
							themeslug_book_length: value > 0 ? value : null
						} ) }
					/>
					<InputControl
...
registerBlockVariation( 'core/button', {
	...
	example: {},
	isActive: (blockAttributes) =>
		'core/post-meta' === blockAttributes?.metadata?.bindings?.url?.source
