...
/**
 * Title: Query Grid: Book Reviews With 5 Stars
 * Slug: themeslug/query-grid-5-stars
 * Categories: featured, posts
 * Viewport Width: 1376
 */

?>
<!-- wp:query {"queryId":15,"query":{"perPage":6,"pages":0,"offset":"0","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":{"category":[]},"bookRating":"5"},"align":"wide","layout":{"type":"default"}} -->
